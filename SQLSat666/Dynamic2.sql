...
SELECT TOP 20 CLE.[Customer No_], CLE.[Posting Date], Cast(CLE.[Sales (LCY)] As Money) As Sales
...
SELECT CU.[Post Code] As Postcode, Datepart(Month, CLE.[Posting Date]) As Mon, Cast(SUM(CLE.[Sales (LCY)]) As Money) AS Amount
