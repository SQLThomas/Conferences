...
de <- data.frame(
  parties = factor(c("AfD", "FDP", "CDU", "CSU", "Fraktionslos", "Gruene", "SPD", "Linke"),
                   levels = c("AfD", "FDP", "CDU", "CSU", "Fraktionslos", "Gruene", "SPD", "Linke")),
  seats   = c(82, 92, 152, 45, 2, 118, 206, 39),
  colors  = c("lightblue", "yellow", "black", "blue", "grey", "green", "red", "purple"),
