...
f1 <- readHTMLTable('http://www.formel1.de/saison/wm-stand/2016/fahrer-wertung', which=1)
f1
...
f1long
ggplot(f1long[f1long$Total > 9, ], aes(x=Race, y=Points, group=Team, colour=Team)) + geom_line()
