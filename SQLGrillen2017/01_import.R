...
browseURL('http://www.imf.org/external/pubs/ft/weo/2017/01/weodata/groups.htm')
weo <- read_tsv('http://www.imf.org/external/pubs/ft/weo/2017/01/weodata/WEOApr2017all.xls', na = c('n/a', '--'))
weo.all <- head(weo, -1)
weo <- read_tsv('http://www.imf.org/external/pubs/ft/weo/2017/01/weodata/WEOApr2017alla.xls', na = c('n/a', '--'))
weo.gr <- head(weo, -1)
