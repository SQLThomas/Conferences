...
park.doc <- getURL('https://services.gis.konstanz.digital/geoportal/rest/services/Fachdaten/Parkplaetze_Parkleitsystem/MapServer/0/query?where=1%3D1&outFields=Name,Parkpl%C3%A4tze,frei,belegt,Status,Stand_von&outSR=4326&f=pjson')
pls <- fromJSON(park.doc)
fnames <- c(pls$fields$name, 'x', 'y')
